<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="<?php echo $this->Url->build('/users'); ?>"><i class="fa fa-circle-o"></i>Users</a></li>
            <li><a href="<?php echo $this->Url->build('/individual-clients'); ?>"><i class="fa fa-circle-o"></i>List of Individual Clients</a></li>
            <li><a href="<?php echo $this->Url->build('/list-of-schools'); ?>"><i class="fa fa-circle-o"></i>List of Schools</a></li>
            <li><a href="<?php echo $this->Url->build('/corporate-clients'); ?>"><i class="fa fa-circle-o"></i>List of Corporate clients </a></li>
            <li><a href="<?php echo $this->Url->build('/products'); ?>"><i class="fa fa-circle-o"></i>Products</a></li>
            <li><a href="<?php echo $this->Url->build('/students'); ?>"><i class="fa fa-circle-o"></i>Students</a></li>
        </ul>
    </li>
    <!--  <li class="treeview">-->
    <!--    <a href="#">-->
