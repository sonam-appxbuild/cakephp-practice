...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $wpWcOrderStat->order_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $wpWcOrderStat->order_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="wpWcOrderStats form content">
            ...
            <fieldset>
                <legend><?= __('Edit Wp Wc Order Stat') ?></legend>
                <?php
