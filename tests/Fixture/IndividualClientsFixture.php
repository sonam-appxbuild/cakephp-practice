...
/**
 * IndividualClientsFixture
 */
class IndividualClientsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'contact' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-01-29 18:10:32',
                'modified' => '2021-01-29 18:10:32',
            ],
        ];
        parent::init();
    }
